        ...
        <div id="contact" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="bg-gradient-to-br from-primary/20 to-indigo-900/20 rounded-2xl p-8 md:p-12 border border-slate-700 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{contactContent.headline}</h2>
                    <p className="text-slate-300 mb-8 text-lg">
                        {isOpenForOpportunities ? contactContent.openDescription : contactContent.description}
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            ...
                            className="h-12 px-8 rounded-lg bg-primary text-white font-bold hover:bg-blue-600 hover:scale-105 hover:shadow-xl hover:shadow-primary/30 active:scale-95 transition-all duration-300 shadow-lg shadow-primary/25 flex items-center justify-center gap-3"
                        >
