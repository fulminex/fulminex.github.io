import { testimonialContent } from '../data/contact';
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex items-center justify-center gap-4">
                    ...
                    <div className="text-left">
                        <div className="font-bold text-slate-900 dark:text-white">{testimonialContent.author}</div>
                        <div className="text-sm text-slate-500 dark:text-slate-400">{testimonialContent.role}</div>
                    </div>
                </div>
            </div>
        </section>
